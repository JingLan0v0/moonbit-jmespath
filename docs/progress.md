...
- Project: MoonJMES, module `JingLan0v0/jmespath`, version 0.1.1.
...
- Cross-platform CI passed on Ubuntu and Windows:
  `https://github.com/JingLan0v0/moonbit-jmespath/actions/runs/35997809718`.
- Mooncakes 0.1.1 is public:
  `https://mooncakes.io/docs/JingLan0v0/jmespath`.
- A separate consumer project installed `JingLan0v0/jmespath@0.1.1`, compiled it,
...
5. [x] Run the PowerShell publish preflight, inspect the archive, then publish 0.1.1.
